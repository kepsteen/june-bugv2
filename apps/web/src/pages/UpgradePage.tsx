...
const PRICING: Record<BillingCycle, { amount: number; cadence: string; note: string }> = {
  monthly: { amount: 6, cadence: '/ month', note: 'Billed monthly. Change or cancel whenever.' },
  yearly: { amount: 5, cadence: '/ month', note: 'Billed $60 yearly — two months on the house.' },
};
...
const PRO_FEATURES = [
  ...
  },
  {
    ...
    description: 'Every entry quietly named for you, the moment you stop writing.',
  },
  {
    icon: Download,
        ...
        <div className="mt-10 grid items-start gap-10 lg:mt-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          ...
          <div className="max-w-[34rem]">
            ...
            <p className="mt-5 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
              You already show up for yourself every day. Pro simply keeps more of
              what you write — every memory, a prompt that knows your story, and a
              journal you can carry anywhere.
            </p>
            ...
            <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
              ...
              <div className="px-7 py-7">
                ...
                <div className="flex items-end justify-center gap-1.5">
                  ...
                  <span className="pb-1.5 text-sm text-muted-foreground">{price.cadence}</span>
                </div>
                <p className="mt-2 text-center text-xs text-muted-foreground">{price.note}</p>
                ...
                <div className="mt-7 border-t border-border/70 pt-6">
                  ...
                  <ul className="mt-3 space-y-2">
                    {FREE_KEEPS.map((item) => (
                      <li key={item} className="flex items-center gap-2.5 text-sm text-card-foreground">
